 ...
 */
package fr.inria.diverse.docl.ide.contentassist.antlr;

import com.google.inject.Inject;
import fr.inria.diverse.docl.ide.contentassist.antlr.internal.InternalDOclParser;
...
public class DOclParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalDOclParser createParser() {
		InternalDOclParser result = new InternalDOclParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getCollectionOperationIDAccess().getAlternatives(), "rule__CollectionOperationID__Alternatives");
					...
					put(grammarAccess.getOclModelElementExpAccess().getGroup(), "rule__OclModelElementExp__Group__0");
					put(grammarAccess.getOclModelElementExpAccess().getGroup_3(), "rule__OclModelElementExp__Group_3__0");
					...
					put(grammarAccess.getOclModelAccess().getUriAssignment_1(), "rule__OclModel__UriAssignment_1");
					...
					put(grammarAccess.getOclModelElementExpAccess().getModelAssignment_0(), "rule__OclModelElementExp__ModelAssignment_0");
					put(grammarAccess.getOclModelElementExpAccess().getNameAssignment_1(), "rule__OclModelElementExp__NameAssignment_1");
					put(grammarAccess.getOclModelElementExpAccess().getElementsAssignment_2(), "rule__OclModelElementExp__ElementsAssignment_2");
					put(grammarAccess.getOclModelElementExpAccess().getElementsAssignment_3_1(), "rule__OclModelElementExp__ElementsAssignment_3_1");
					put(grammarAccess.getOclModelElementExpAccess().getTargetAssignment_4(), "rule__OclModelElementExp__TargetAssignment_4");
					...
					put(grammarAccess.getOclAnyTypeAccess().getNameAssignment(), "rule__OclAnyType__NameAssignment");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			InternalDOclParser typedParser = (InternalDOclParser) parser;
