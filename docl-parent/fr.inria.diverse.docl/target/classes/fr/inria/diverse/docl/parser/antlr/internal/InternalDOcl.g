...
// Entry rule entryRuleCollectionOperationID
entryRuleCollectionOperationID returns [String current=null]:
	{ newCompositeNode(grammarAccess.getCollectionOperationIDRule()); }
	iv_ruleCollectionOperationID=ruleCollectionOperationID
	{ $current=$iv_ruleCollectionOperationID.current.getText(); }
	EOF;

// Rule CollectionOperationID
ruleCollectionOperationID returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_OclModelElementExp_6.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
@after {
	...
	(
		...
		{
			$current = $this_OclAnyType_8.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_OclModelElement_10.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
