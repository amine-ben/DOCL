 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.docl.docl.URI_#getScheme <em>Scheme</em>}</li>
 *   <li>{@link fr.inria.diverse.docl.docl.URI_#getAuthority <em>Authority</em>}</li>
 *   <li>{@link fr.inria.diverse.docl.docl.URI_#getFragment_ <em>Fragment </em>}</li>
 * </ul>
 *
 * @see fr.inria.diverse.docl.docl.DoclPackage#getURI_()
 * @model
 * @generated
 */
public interface URI_ extends EObject
{
   ...
   * @see fr.inria.diverse.docl.docl.DoclPackage#getURI__Scheme()
   * @model
   * @generated
   */
  String getScheme();
  ...
  /**
   * Sets the value of the '{@link fr.inria.diverse.docl.docl.URI_#getScheme <em>Scheme</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.inria.diverse.docl.docl.DoclPackage#getURI__Authority()
   * @model
   * @generated
   */
  String getAuthority();
  ...
  /**
   * Sets the value of the '{@link fr.inria.diverse.docl.docl.URI_#getAuthority <em>Authority</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.inria.diverse.docl.docl.DoclPackage#getURI__Fragment_()
   * @model
   * @generated
   */
  String getFragment_();
  ...
  /**
   * Sets the value of the '{@link fr.inria.diverse.docl.docl.URI_#getFragment_ <em>Fragment </em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
