 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.docl.docl.impl.StringLiteralExpImpl#getSegments <em>Segments</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringLiteralExpImpl extends PrimitiveExpImpl implements StringLiteralExp
{
  ...
  {
    return DoclPackage.Literals.STRING_LITERAL_EXP;
  }
  ...
  public EList<String> getSegments()
  {
    if (segments == null)
    {
      segments = new EDataTypeEList<String>(String.class, this, DoclPackage.STRING_LITERAL_EXP__SEGMENTS);
    }
    return segments;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DoclPackage.STRING_LITERAL_EXP__SEGMENTS:
        return getSegments();
    }
